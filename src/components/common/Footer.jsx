...
const Footer = () => {
  return (
    <footer className="w-full relative bottom-0 z-10 p-4 bg-black sm:px-6 lg:px-8 mx-auto">
      <div className="text-center text-white">
        Designed & Developed by <span className="font-bold"> Saad Shaikh</span>
      </div>
      <div className="space-x-2 text-center">
        <a
          className="inline-flex justify-center items-center size-10 text-center text-gray-500 hover:text-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white transition dark:text-gray-500 dark:hover:text-gray-200 dark:hover:bg-gray-800"
        ...
        <a
          className="inline-block text-gray-500 hover:text-gray-100 dark:hover:text-gray-200"
          href="https://x.com/SaadShaikh0"
        >
          <svg
