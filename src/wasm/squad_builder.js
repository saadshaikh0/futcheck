 ...
 * @returns {string}
 */
export function find_best_squad_with_progress(players_json, constraints_json, progress_callback) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passStringToWasm0(players_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        ...
        const ptr1 = passStringToWasm0(constraints_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.find_best_squad_with_progress(ptr0, len0, ptr1, len1, progress_callback);
        var ptr3 = ret[0];
        var len3 = ret[1];
        if (ret[3]) {
            ptr3 = 0; len3 = 0;
